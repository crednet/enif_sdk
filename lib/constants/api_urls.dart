...
class ApiUrls {
  ...
  static String ticketStatus(String ticketId) => "api/ticket/$ticketId/read-status";
  static String updateTicketStatus(String ticketId) => "api/ticket/$ticketId/update-read-status";
