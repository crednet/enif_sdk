...
// import 'package:mobile/models/pagination/pagination.dart' as m;
...
class JsonInterceptor<ErrorType extends ApiError> implements ApiInterceptor {
  ...
  dynamic _decode<T>(entity) {
    ...
    if (T == Map<String, dynamic>) return entity as Map<String, dynamic>;
  ...
  dynamic _getBody(dynamic body, [String? key = '']) {
    ...
    try {
      ...
      if (kDebugMode) {
        print('get body error, $key, ${body.runtimeType}, $body, \n$_');
      }
      return body;
    }
  }
